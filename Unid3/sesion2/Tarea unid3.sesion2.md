...
- **Nombre del estudio:**  
  ...
  > Prostate Cancer (MSK, Clin Cancer Res 2024)mplo: Pancreatic Cancer (MSK, Cancer Cell 2024)
...
- **Cita de articulo referencia**
  
  >   Lenis AT, Ravichandran V, Brown S, Alam SM, Katims A, Truong H, Reisz PA, Vasselman S, Nweji B, Autio KA, Morris MJ, Slovin SF, Rathkopf D, Danila D, Woo S, Vargas HA, Laudone VP, Ehdaie B, Reuter V, Arcila M, Berger MF, Viale A, Scher HI, Schultz N, Gopalan A, Donoghue MTA, Ostrovnaya I, Stopsack KH, Solit DB, Abida W. Microsatellite Instability, Tumor Mutational Burden, and Response to Immune Checkpoint Blockade in Patients with Prostate Cancer. Clin Cancer Res. 2024 Sep 3;30(17):3894-3903. doi: 10.1158/1078-0432.CCR-23-3403. PMID: 38949888; PMCID: PMC11371520.

---

Resumen portal 

![texto alternativo](https://github.com/Robertonaranjop/Tareas_BioinfRepro2025_Rnaranjo/blob/main/Unid3/sesion2/Imagenes/CBioportal.png)

Clinical data

![texto alternativo](https://github.com/Robertonaranjop/Tareas_BioinfRepro2025_Rnaranjo/blob/main/Unid3/sesion2/Imagenes/Clinical%20Data.png)
...
| --- | ----- | ---------------- | --------------- | -------------- |
| 1   | TP53  | 688              | 648             | 28.7           |
| 2   | FOXA1 | 377              | 351             | 15.6           |
| 3   | SPOP  | 325              | 318             | 14.1           |
| 4   | PTEN  | 198              | 178             | 7.9            |
| 5   | APC   | 193              | 173             | 7.7            |

4. Selecciona **uno de esos genes** (ejemplo: *KRAS*, *TP53*, *PIK3CA*) y filtra las muestras 
   
   **R**: Seleccione TP53  el cual tiene una frecuencia de 29% 
...
- ¿Qué vías de señalización aparecen alteradas en la pestaña *Pathways*?  
  ...
  > RTK-PAS, PI3K NOTCH, WNT

## 👩‍⚕️ Parte 3: Análisis clínico
...
![texto alternativo](https://github.com/Robertonaranjop/Tareas_BioinfRepro2025_Rnaranjo/blob/main/Unid3/sesion2/Imagenes/Etnias.png)

3. Calcula:
   
   - **Rango de edad (edad máxima − edad mínima):**  
     
     > Podemos observar que la edad se distribuye entre los 40 a 89 años, 
   
   - **Mediana de edad (usando “Compare Groups → Median”):**  
     
     > 71 años

![texto alternativo](https://github.com/Robertonaranjop/Tareas_BioinfRepro2025_Rnaranjo/blob/main/Unid3/sesion2/Imagenes/Edad.png)

4. **Interpreta los resultados:**
   
   - ¿Existe una predominancia por sexo o edad?  
     
     > Una predominancia por edad a partir de los 40 años pero más casos estudiados entre los 55 y 75 años , ya que solo es un cancer que afecta a personas con prostata de sexo masculino.
   
   - ¿Qué implicancias podría tener esa distribución para el estudio del cáncer elegido?  
     
     > Que es importante que personas con prostata se evaluen desde los 40 años para detectar a tiempo y tomar tratamiento que permita frenar el avace del cancer 
